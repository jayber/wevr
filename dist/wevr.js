...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SignallingClient_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RTCConnectionBroker_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__StateHandler_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_aframe_gamepad_controls__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_aframe_gamepad_controls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_aframe_gamepad_controls__);
...
AFRAME.registerSystem('wevr', {
  schema: {period: {type: "number", default: 100}},
  init() {
    this.signaller = new __WEBPACK_IMPORTED_MODULE_0__SignallingClient_js__["a" /* default */]("localhost:9000/wevr");
    ...
    broker.onaudio = (stream, peer) => {
      ...
      this.findPeerElement(peer, this.el).appendChild(element);
    ...
    this.channels.addEventListener("open", (data, peer) => {
      let element = document.createElement("a-entity");

      element.setAttribute("wevr-avatar", "");
      element.setAttribute("visible", "false");
      this.findPeerElement(peer, this.el.sceneEl).appendChild(element);

      this.channels.addEventListenerForPeer(peer, "wevr.movement", (event) => {
        this.updateMovement(element, event);
      });

      this.channels.addEventListenerForPeer(peer, "wevr.movement-init", (event) => {
    ...
    this.stateHandler.addStateListener("#environment", (data) => {
      this.system = this.el.systems['switch-environment'].setEnvironmentIndex(data.envName);
    });
  },
...
AFRAME.registerComponent('wevr-player', {
  ...
  tick(time, delta) {
    if (!this.lastSent || time - this.lastSent > this.period) {
      ...
      if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](this.position, position) || !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](this.quaternion, quaternion)) {
...
AFRAME.registerComponent('switch-environment', {
  ...
  init: function () {
    ...
    this.el.addEventListener('click', (evt) => {
      this.system.switchEnvironment(up);
    });
  }
});
...
AFRAME.registerSystem('switch-environment', {
  initAfterLoaded: function () {
    ...
    let wevrSystem = this.el.systems.wevr;
    this.stateHandler = wevrSystem.stateHandler;
  },
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DataChannels_js__ = __webpack_require__(3);
...
class RTCConnectionBroker {
  ...
  constructor(signallingClient) {
    ...
    this.connections = {};
    this.dataChannels = new __WEBPACK_IMPORTED_MODULE_0__DataChannels_js__["a" /* default */]();
...
var GamepadButton = __webpack_require__(6),
    GamepadButtonEvent = __webpack_require__(7);
